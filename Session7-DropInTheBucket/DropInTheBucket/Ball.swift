...
class Ball: SKShapeNode {
    ...
    convenience init(position: CGPoint) {
        ...
        self.physicsBody!.contactTestBitMask = PhysicsCategory.Spoon | PhysicsCategory.Hole
        self.physicsBody!.collisionBitMask = PhysicsCategory.Spoon | PhysicsCategory.Hole | PhysicsCategory.Floor
